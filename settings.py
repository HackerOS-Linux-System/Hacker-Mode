...
class SettingsWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.title.setFont(QFont('Hack', 48, QFont.Bold))
        ...
        self.wifi_layout.setSpacing(25)
        self.wifi_title = QLabel(get_text('wifi_settings'))
        self.wifi_title.setFont(QFont('Hack', 22, QFont.Bold))
        ...
        self.wifi_list_layout.setSpacing(20)
        ...
        self.wifi_password.setFixedHeight(60)
        ...
        self.bluetooth_layout.setSpacing(25)
        self.bluetooth_title = QLabel(get_text('bluetooth'))
        self.bluetooth_title.setFont(QFont('Hack', 22, QFont.Bold))
        ...
        self.bluetooth_list_layout.setSpacing(20)
        ...
        self.pair_btn.setFixedHeight(60)
        ...
        self.back_btn.setFont(QFont('Hack', 24, QFont.Bold))
        ...
        self.close_btn.setFixedSize(300, 100)
        self.close_btn.setFont(QFont('Hack', 24, QFont.Bold))
    ...
    def add_display_panel(self):
        ...
        toggle_theme.setFixedHeight(60)
    ...
    def add_network_panel(self):
        ...
        wifi_settings.setFixedHeight(60)
