...
const { getText, setGamingTool } = require('./utils');
...
ipcMain.handle('setLanguage', async (event, newLang) => {
    ...
    if (settingsWindow) {
        ...
        document.getElementById('gaming-tools-title').innerText = '${getText('gaming_tools')}';
        ...
        document.getElementById('label_enable_gamescope').innerText = '${getText('enable_gamescope')}';
        document.getElementById('label_enable_mangohud').innerText = '${getText('enable_mangohud')}';
        document.getElementById('label_enable_vkbasalt').innerText = '${getText('enable_vkbasalt')}';
...
ipcMain.handle('toggleGamingTool', async (event, tool, enabled) => {
    require('./utils').setGamingTool(tool, enabled);
    log(`Toggled ${tool} to ${enabled}`, 'info');
});
